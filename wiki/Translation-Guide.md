...
```bash
bench --site dev.localhost get-untranslated ar --app base_base
```

### 2. Translation file format — تنسيق ملف الترجمة

File: `base_base/translations/ar.csv`
...
bench --site dev.localhost get-untranslated ar --app base_base | wc -l
```
...
2. Edit/create the CSV file in `base_base/translations/`
