...
Base Base follows the Arkan Lab architecture standards built on Frappe v16.
...
class MyDocType(Document):
    def validate(self):
        from base_base.services.my_service import MyService
...
```python
from base_base.api.response import success, error, paginated
