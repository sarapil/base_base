"""
Base Base — Demo Data
Load/clear demo data for Base Base showcases.
...
def load_demo_data():
    """Load demonstration data for Base Base.
    ...
    try:
        ...
        frappe.db.commit()
        frappe.msgprint(_("Demo data loaded for Base Base"))
    finally:
...
def clear_demo_data():
    ...
    frappe.db.commit()
    frappe.msgprint(_("Demo data cleared for Base Base"))
